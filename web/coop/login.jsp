...
<head>
    ...
    <link href="/css/cply/admin.css" type="text/css" rel="stylesheet">
    ...
    <tr>
        ...
        <td align=middle>
            ...
            <table width="619" height="284" border="0" align="center" cellpadding="0" cellspacing="0"
                   background="/images/loginbg-coop.jpg">
                    ...
                    <tr>
                        <td height="282" valign="top">
                            ...
                            <div class="login_boxjj">
                                <ul>
                                    <li><input type="hidden" value="2" name="adminType"/>用户名：<input type="text"
                                                                                                    class="shukuan"
