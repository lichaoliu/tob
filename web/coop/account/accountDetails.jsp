...
<head>
    ...
    <script type="text/javascript">
        function exportExcel() {
            ...
            $("#form1").attr("action", "${pageContext.request.contextPath}/coop/outData?action=accountDetail");
            $("#form1").submit();
    ...
    <tr>
        <td style="padding: 4px;">
            <form name="form1" id="form1" method="post"
                  action="${pageContext.request.contextPath}/coop/cooperationServlet?action=getAccountLogList">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="eventCode">
                                ...
                                <option value="0" <c:if test="${param.eventCode == '0'}">selected</c:if>>收入</option>
                                <option value="00100"
                                ...
                                <option value="1" <c:if test="${param.eventCode == '1'}">selected</c:if>>支出</option>
                                <option value="10000"
                        ...
                        <tr>
                          ...
                          <!--  <td align="right">
                            ...
                            <td align="right">
                             ...
                             <td align="right">
                             <fmt:formatNumber
                                    value="${accountLogList[0].bonusAmountNew + accountLogList[0].rechargeAmountNew}"
                                    pattern="0.00"/>
                                
                            </td>
                            <td align="left">
                                <c:if test="${accountLogList[0].eventCode != '00500' && accountLogList[0].eventCode != '10400'}">
                    ...
                    <tr>
                        <td colspan="11" align="right">
                            <page:pageTag page="${requestScope.page}" pageSize="${requestScope.pageSize}"
                                          ...
                                          gotoURI="${pageContext.request.contextPath}/coop/cooperationServlet?action=getAccountLogList"/>
                        </td>
                    </tr>
                </c:if>
            </table>
