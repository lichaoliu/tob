    ...
    <tr>
        <td style="padding: 4px;">
            <form name="form1" method="post"
                  action="${pageContext.request.contextPath}/coop/cooperationServlet?action=bonusList">
                    ...
                    <tr>
                        <td colspan="6" align="right">
                            <page:pageTag page="${requestScope.page}" pageSize="${requestScope.pageSize}"
                                          ...
                                          gotoURI="${pageContext.request.contextPath}/coop/cooperationServlet?action=bonusList"/>
                        </td>
                    </tr>
                </c:if>
            </table>
