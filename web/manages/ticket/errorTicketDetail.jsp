...
<script type="text/javascript">
    ...
    function onFailed() {
        ...
        window.location.href = "${pageContext.request.contextPath}/manages/ticketManagesServlet?action=successCancelTicket&ticketId=" + ticketId;
    }
</script>
<body onload="init()">
...
<tr>
    <td colspan="2" align="center">
        <input type="button" class="submit" value="退款" style="width: 64px; border: none" onclick="onFailed();"/>
