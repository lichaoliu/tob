...
<head>
    ...
    <script type="text/javascript">
        ...
        function onFailed() {
        	 ...
        	 window.location.href = "${pageContext.request.contextPath}/manages/ticketManagesServlet?action=failedTicket&ticketId="+ticketId;
        }
        function onReSend(){
        	var ticketId = $("#ticketId").val();
        	 window.location.href = "${pageContext.request.contextPath}/manages/ticketManagesServlet?action=reSendTicket&ticketId="+ticketId;
        }
    </script>
<body onload="init()">
...
<c:choose>
    <c:when test="${ticket.lotteryCode == '200' || ticket.lotteryCode == '201'}">
...
<tr>
    <td colspan="2" align="center">
    	<input type="button" class="submit" value="重发" style="width: 64px; border: none" onclick="onReSend();"/>
        <input type="button" class="submit" value="失败退款" style="width: 64px; border: none" onclick="onFailed();"/>
