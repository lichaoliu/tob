...
<head>
    ...
    <script type="text/javascript">
        function exportExcel() {
            ...
            $("#form1").attr("action", "${pageContext.request.contextPath}/manages/outData?action=lotteryDateCount&type=1");
            $("#form1").submit();
    ...
    <tr>
        <td style="padding: 4px;">
            <form name="form1" method="post" id="form1"
                  action="${pageContext.request.contextPath}/manages/countServlet?action=lotteryDateCount&type=1">
                ...
                <tr>
                    <td colspan="11" align="right">
                        <page:pageTag page="${requestScope.page}" pageSize="${requestScope.pageSize}"
                                      ...
                                      gotoURI="${pageContext.request.contextPath}/manages/countServlet?action=lotteryDateCount&type=1"/>
                    </td>
                </tr>
            </table>
        </td>
