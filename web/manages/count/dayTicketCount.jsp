    ...
    <tr>
        <td style="padding: 4px;" colspan="2">
            <form name="form1" id="form1" method="post"
                  action="${pageContext.request.contextPath}/manages/countServlet?action=dayTicketCount">
                ...
                <c:if test="${pageBean.pageContent!=null}">
                    <c:forEach var="sub" items="${pageBean.pageContent}" varStatus="cont">
                        <tr>
                            ...
                            <td>
                                金额:<fmt:formatNumber value="${sub.SA}" pattern="0.00"/><br/>
                                票数:${sub.SNUM}
                            </td>
                            <td>
                                金额:<fmt:formatNumber value="${sub.WA}" pattern="0.00"/><br/>
                                票数:${sub.WNUM}
                            </td>
                            <td>
                                金额:<fmt:formatNumber value="${sub.FA}" pattern="0.00"/><br/>
                                票数:${sub.FNUM}
                            </td>
                            <td align="left">
                                票数:${sub.BNUM}<br/>
                                税前:<fmt:formatNumber value="${sub.FBA}" pattern="0.00"/><br/>
                                税后:<fmt:formatNumber value="${sub.BA}" pattern="0.00"/>
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
