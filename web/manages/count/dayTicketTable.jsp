    ...
    <tr>
        <td style="padding: 4px;" colspan="2">
            <form name="form1" id="form1" method="post"
                  action="${pageContext.request.contextPath}/manages/countServlet?action=dayTicketTable">
                ...
                <c:if test="${pageBean.pageContent!=null}">
                    <c:forEach var="sub" items="${pageBean.pageContent}" varStatus="cont">
                        <tr align="right">
                            ...
                            <td align="center"><a href="${pageContext.request.contextPath}/manages/countServlet?action=dayTicketTableForSub&startDate=${sub.curDate}&endDate=${sub.curDate}" target="_blank">${sub.curDate}</a></td>
                            <td>${sub.successTicket}</td>
                            <td><fmt:formatNumber value="${sub.successAmount}" pattern="0.00"/></td>
                            <td>${sub.waitTicket}</td>
                            <td><fmt:formatNumber value="${sub.waitAmount}" pattern="0.00"/></td>
