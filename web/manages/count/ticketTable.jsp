    ...
    <tr>
        <td style="padding: 4px;" colspan="2">
            <form name="form1" id="form1" method="post"
                  action="${pageContext.request.contextPath}/manages/countServlet?action=ticketTable">
                    ...
                    <c:forEach var="sub" items="${pageBean.pageContent}" varStatus="cont">
                        <tr>
                            ...
                            <td>
                                ...
                                期次:<a
                                    href="${pageContext.request.contextPath}/manages/countServlet?action=ticketTableForSub&lotteryCode=${sub.lotteryCode}&issue=${sub.issue}"
                                    target="_blank">${sub.issue}</a>
                            </td>
                            <td>
