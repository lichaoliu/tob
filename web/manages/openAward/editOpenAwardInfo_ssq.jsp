...
//                $("#lv1"+i+"zu").keyup(regInteger);
        ...
        function regSubmit(bonusNumber){
            //var reg = /^(\d{2},){5}\d{2}#\d{2}$/;
            var reg = /^(\d{2},){5}\d{2}#\d{2},\d{2}$/;
...
<tr>
    <td colspan="2" align="center">双色球第${issue.name}期开奖信息录入</td>
</tr>
<tr>
...
<tr>
    <td colspan="2" width="20%" align="center">
        录入格式举例：开奖号码的前区为01,02,03,04,05,06;后区为01
        <br/>则录入01,02,03,04,05,06#01
    </td>
</tr>
<tr>
    <td colspan="2">
