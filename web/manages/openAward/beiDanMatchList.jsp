    ...
    <tr>
        <td style="padding: 4px;">
            ...
            <form name="form1" method="post"
                  action="${pageContext.request.contextPath}/manages/openAward?action=openBeiDan">
                ...
                <c:if test="${pageBean.pageContent!=null}">
                    <c:forEach var="beiDan" items="${pageBean.pageContent}" varStatus="cont">
                        <tr>
                            ...
                            <td align="center">
                                <c:if test="${beiDan.operatorsAward == 0}"><a href="${pageContext.request.contextPath}/manages/openAward?action=editOpenBeiDan&id=${beiDan.id}">编辑</a></c:if>
                    ...
                    <tr>
                        <td colspan="11" align="right">
                            <page:pageTag page="${requestScope.page}" pageSize="${requestScope.pageSize}"
                                          ...
                                          gotoURI="${pageContext.request.contextPath}/manages/openAward?action=openBeiDan"/>
                        </td>
                    </tr>
                </c:if>
            </table>
