    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#subBtn").click(function() {
                ...
                var str = "足球胜负彩第${issue.name}期，开奖号码为" + bonusNumberStr.substring(0, bonusNumberStr.length - 1);
        ...
        <td style="padding: 4px;">
            <form name="awardForm" id="awardForm" method="post"
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0" class="seach_none">
                    <tr>
                        <td colspan="2" align="center">足彩胜负彩第${issue.name}期开奖信息录入</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <table width="70%" border="0" cellpadding="4" cellspacing="0" class="sub">
                                <tr>
                                    <th colspan="2">主队VS客队</th>
                                    <th>比赛结果<br/>(胜3，平1，负0 <br/>注：取消的场次填入9)</th>
                                    <th>上半场比分(填入数字)<br/>主队：客队</th>
                                    <th>全场比分(填入数字)<br/>主队：客队</th>
                                </tr>
                                <c:forEach var="subGame" items="${subGameList}" varStatus="cont">
                                    <tr>
                                        <td width="30">&nbsp;&nbsp;</td>
                                        <td align="left">${cont.count}.${subGame.masterName}VS${subGame.guestName}</td>
                                        <td align="center"><input type="text" value="${bonusNumber[cont.count - 1]}"
                                                                  id="bonusNumber"
                                                                  name="bonusNumber" size="10" reg="^\d+$"
                                                                  tip="赛果不能为空"/>
                                        </td>
                                        <td align="center"><input type="text" value="${scoreAtHalfz[cont.count - 1]}"
                                                   id="scoreAtHalfz"
                                                   name="scoreAtHalfz" size="3"/> : <input type="text"
                                                                                         value="${scoreAtHalfk[cont.count - 1]}"
                                                                                         id="scoreAtHalfk"
                                                                                         name="scoreAtHalfk"
                                                                                         size="3"/></td>
                                        <td align="center"><input type="text" value="${secondHalfTheScorez[cont.count - 1]}"
                                                   id="secondHalfTheScorez" name="secondHalfTheScorez"
                                                   size="3"/> : <input
                                                type="text"
                                                value="${secondHalfTheScorek[cont.count - 1]}"
                                                id="secondHalfTheScorek"
                                                name="secondHalfTheScorek"
                                                size="3"/></td>
                                    </tr>
                                </c:forEach>
                            </table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="${lv02}" id="lv02" name="lv02" size="22"/>元
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="${lv02zu}" id="lv02zu" name="lv02zu" size="22"/>注
                        </td>
                    </tr>
