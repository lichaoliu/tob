    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#subBtn").click(function() {
                ...
                var str = "足球半全场第${issue.name}期，开奖号码为" + bonusNumberStr.substring(0, bonusNumberStr.length - 1) + "\n";
        ...
        <td style="padding: 4px;">
            <form name="awardForm" id="awardForm" method="post"
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0" class="seach_none">
                    <tr>
                        <td colspan="2" align="center">足彩半全场第${issue.name}期开奖信息录入</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            <br/><b>1.比赛结果（胜3，平1，负0） 注：取消的场次填入9</b>
                        </td>
                    </tr>
                    ...
                    <td colspan="2" align="center">
                        <table width="75%" border="0" cellpadding="4" cellspacing="0" class="sub">
                            ...
                            <c:forEach var="subGame" items="${subGameList}" varStatus="cont">
                                <tr>
                                    <td width="20">&nbsp;</td>
                                    <td align="left">${cont.count * 2 - 1}、${subGame.masterName}VS${subGame.guestName}</td>
                                    <td align="center">
                                        半 : <input type="text" value="${bonusNumber[(cont.count - 1)*2]}"
                                                   id="bonusNumber"
                                                   name="bonusNumber" size="10" reg="^\d+$" tip="比赛结果不能为空"/>
                                    </td>
                                    <td align="center">主 : <input type="text" value="${scoreAtHalfz[cont.count - 1]}"
                                                                  id="scoreAtHalfz"
                                                                  name="scoreAtHalfz" size="3"/>
                                    </td>
                                    <td align="center">主 : <input type="text"
                                                                  value="${secondHalfTheScorez[cont.count - 1]}"
                                                                  id="secondHalfTheScorez" name="secondHalfTheScorez"
                                                                  size="3"/></td>
                                </tr>
                                <tr>
                                    <td width="30">&nbsp;&nbsp;</td>
                                    <td align="left">${cont.count * 2}、${subGame.masterName}VS${subGame.guestName}</td>
                                    <td align="center">
                                        全 : <input type="text" value="${bonusNumber[cont.count * 2 - 1]}"
                                                   id="bonusNumber"
                                                   name="bonusNumber" size="10" reg="^\d+$" tip="比赛结果不能为空"/>
                                    </td>
                                    ...
                                    <td align="center">客 : <input type="text"
