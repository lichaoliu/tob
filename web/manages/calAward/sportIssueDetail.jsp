...
<form id="awardForm" method="post"
      action="${pageContext.request.contextPath}/manages/calculateAwardServlet?action=sportCalculateAward">
    ...
    <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="table table1">
        <tr>
            <td class="title">
                ${lotteryName}第${mainIssue.name}算奖
            </td>
        </tr>
        <tr>
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0" class="seach_none">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="button" class="submit" value="开始算奖" id="calAwardBtn" style="width: 100px; border: none"/>

                            <input type="button" class="submit" value="取消" style="width: 64px; border: none" onclick="javascript:history.go(-1);"/>
                        </td>
                    </tr>
                </table>
            </td>
