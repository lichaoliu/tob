...
<form id="awardForm" method="post"
      action="${pageContext.request.contextPath}/manages/sendWinManagesServlet?action=footballSendWin">
    ...
    <input type="text" name="matchNo" value="${matchNo}"/>
    <input type="text" name="mainTeam" value="${mainTeam}"/>
    <input type="text" name="guestTeam" value="${guestTeam}"/>
    <input type="text" name="matchName" value="${matchName}"/>
    <input type="text" name="bonusOperator" value="${bonusOperator}"/>
    <input type="hidden" name="bonusOperator" value="${bonusOperator}"/>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table1">
        <tr>
            <td class="title">
                竞彩足球赛事${football.issue}${football.week}${football.sn}派奖
            </td>
        </tr>
        <tr>
