...
<form name="form1" method="post" id="form1"
      action="${pageContext.request.contextPath}/manages/postTicketServlet?action=postTicketList">
        ...
        <tr>
            <td colspan="11" align="right">
                <page:pageTag page="${requestScope.page}" pageSize="${requestScope.pageSize}"
                              ...
                              gotoURI="${pageContext.request.contextPath}/manages/postTicketServlet?action=postTicketList"/>
            </td>
        </tr>
    </c:if>
</table>
