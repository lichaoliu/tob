 ...
 * 高频查询期次
 */
public class LtkjIssueQueryJobBean extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext arg0) throws JobExecutionException {
		...
		boolean lock = distributionLockService.doStartLock(new DistributionLock(DistributionLock.LOCK_FOR_LTKJ_ISSUE_QUERY));
		if (!lock)
			return;
		try {
		...
		distributionLockService.doEndLock(new DistributionLock(DistributionLock.LOCK_FOR_LTKJ_ISSUE_QUERY));
