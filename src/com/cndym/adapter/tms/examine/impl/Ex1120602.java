 ...
 */
@Component
public class Ex1120602 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1120602.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1120602", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1120602 ex1110602 = new Ex1120602();
        ex1110602.examina("01,02,03,04,05,06,07", 7);
