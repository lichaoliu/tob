 ...
 */
@Component
public class Ex1021002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1021002.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1021002", nums);
         for (String n : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1021002 ex1021002 = new Ex1021002();
