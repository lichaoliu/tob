...
@Component
public class Ex1071403 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("1071403");
        ...
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 1L, 0L);
    ...
    public static void main(String[] s){
    	Ex1071403 e = new Ex1071403();
    	e.examina("01@02,03", 2);
    }
}
