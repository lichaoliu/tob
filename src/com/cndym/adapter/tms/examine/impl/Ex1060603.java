 ...
 */
@Component
public class Ex1060603 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1060603.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1060603", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1060603 ex0063001 = new Ex1060603();
        ex0063001.examina("01@02,03,04,08,09,10;01@02,03,04,09,10,11", 12);
