...
@Component
public class Ex0020217 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0020217.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0020217", nums);
        int temp = 0;
        for (String num : nums) {
    ...
    public static void main(String[] ages) {
        Ex0020217 ex0020204 = new Ex0020217();
        ex0020204.examina("4", 3);
