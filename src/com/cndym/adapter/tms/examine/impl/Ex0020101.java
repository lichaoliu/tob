...
@Component
public class Ex0020101 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0020201.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0020101", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex0020101 ex0020101 = new Ex0020101();
        ex0020101.examina("0,3,1", 1);
