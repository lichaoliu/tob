 ...
 */
@Component
public class Ex1121002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1121002.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1121002", nums);
         for (String n : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1121002 ex1110902 = new Ex1121002();
