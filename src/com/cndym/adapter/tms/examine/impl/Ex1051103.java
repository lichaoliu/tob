 ...
 */
@Component
public class Ex1051103 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1051103.class);
...
//        throw new CndymException(ErrCode.E8117);
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1051103", nums);
        for (String n : nums) {
//        校验格式
