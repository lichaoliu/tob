 ...
 */
@Component
public class Ex1041103 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041103.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1041103", nums);
//        for (String n : nums) {
////        校验格式
