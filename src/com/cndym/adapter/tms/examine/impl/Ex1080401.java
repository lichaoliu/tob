 ...
 */
@Component
public class Ex1080401 extends BashExamina implements IExamine {
	private Logger logger = Logger.getLogger(Ex1080401.class);
	...
	public void examina(String number, int item) {
		...
		for (String num : nums) {
			...
			if (map.size() < 3) {
				throw new IllegalArgumentException("三个号码必须各不能相同");
			}
		}
		// 校验注数
		if (item != nums.length) {
	...
	public static void main(String[] args) {
		Ex1080401 ex = new Ex1080401();
		ex.examina("1,2,3;1,2,3;1,5,2;1,7,3;1,5,2", 5);
