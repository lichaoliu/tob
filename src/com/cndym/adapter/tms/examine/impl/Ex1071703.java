...
@Component
public class Ex1071703 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("1071703");
        ...
        for (String num : nums) {            
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 5L, -1L);
            NumberLengthExamine.defaultNumberLengthExamine(arr[1], ",", 1L, 1L);
            NumberAreaExamine.defaultNumberAraeExamine(arr[0].split(","), 0, 11, 2);
            NumberAreaExamine.defaultNumberAraeExamine(arr[1].split(","), 0, 11, 2);
    ...
    public static void main(String[] s){
    	Ex1071703 e = new Ex1071703();
    	e.examina("01,02@03,04,05,06", 4);
    }
}
