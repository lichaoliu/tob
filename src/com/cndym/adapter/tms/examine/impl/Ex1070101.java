 ...
 */
@Component
public class Ex1070101 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1070101.class);
    ...
    public void examina(String number, int item) {
        ...
        NumberTicketCountExamine.defaulstNumberSortExamine("1070101", nums);
//        NumberRepeatExamine.defaultNumberRepeatExamine(number, ztag, 0);//验证号码是否有重复
    ...
    public static void main(String[] args) {
        Ex1070101 ex0063001 = new Ex1070101();
