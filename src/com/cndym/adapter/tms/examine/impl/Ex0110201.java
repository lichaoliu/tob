...
@Component
public class Ex0110201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0110201.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0110201", nums);
    ...
    public static void main(String[] ages) {
        Ex0110201 ex0070201 = new Ex0110201();
        ex0070201.examina("1,2,2;1,2,2;2,2,6", 3);
    }
}
