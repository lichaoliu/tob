 ...
 */
@Component
public class Ex1041303 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041303.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1041303", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1041303 ex0063001 = new Ex1041303();
        ex0063001.examina("01,02@03,07", 2);
