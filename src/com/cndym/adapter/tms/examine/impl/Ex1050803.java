 ...
 */
@Component
public class Ex1050803 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1050803.class);
...
//        NumberTicketCountExamine.defaulstNumberSortExamine("1050803", nums);
//        int temp = 0;
//        for (String num : nums) {
//            //校验格式
