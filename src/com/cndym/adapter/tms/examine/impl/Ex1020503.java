 ...
 */
@Component
public class Ex1020503 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1020503.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1020503", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	//校验格式
        	NumberTagExamine.defaultNumberTagExamine(num, new String[]{",", "@"});//号码中分隔符的验证
            String[] arr = num.split("@");
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 5, -1);//号码个数的验证，胆码应该小于5
    ...
    public static void main(String[] args) {
        Ex1020503 ex1020503 = new Ex1020503();
        ex1020503.examina("01,02,03,07@04,05,08", 3);
