...
@Component
public class Ex1071602 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("1071602");
        ...
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(num, ",", 4L, 1L);
    ...
    public static void main(String[] s){
    	Ex1071602 e = new Ex1071602();
    	e.examina("01,02,03,04,05", 5);
    }
}
