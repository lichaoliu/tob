...
@Component
public class Ex0080201 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticketCount = getTicketCount("0080201");
    ...
    public static void main(String[] args) {
        Ex0080201 ex0060101 = new Ex0080201();
        ex0060101.examina("9,2;9,2;9,2;9,9;9,2", 5);
