 ...
 */
@Component
public class Ex1140502 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1140502.class);

    @Override
    public void examina(String number, int item) {
    	String[] nums = number.split(ztag);
    	int temp = 0;
    	NumberTicketCountExamine.defaulstNumberSortExamine("1140502", nums);
        for(String num : nums){
	        //校验格式
    ...
    public static void main(String[] args) {
        Ex1140502 ex0063001 = new Ex1140502();
        ex0063001.examina("01,02,03,04,05,06,07,08,09,10,11,12,13", 1287);
