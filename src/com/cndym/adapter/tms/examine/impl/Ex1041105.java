 ...
 */
@Component
public class Ex1041105 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041105.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1041105", nums);
//        for (String n : nums) {
//            //校验格式
...
//            NumberAreaExamine.defaultNumberAraeExamine(arr[2].split(","), 1, 11, 2);//号码域验证
//            int a = arr[0].split(",").length;
//            int b = arr[1].split(",").length;
//            int c = arr[2].split(",").length;
//            temp += a * b * c;
//        }
//        if (temp != item) {
