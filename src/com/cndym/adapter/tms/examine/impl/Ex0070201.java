...
@Component
public class Ex0070201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0070201.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0070201", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] ages) {
        Ex0070201 ex0070201 = new Ex0070201();
