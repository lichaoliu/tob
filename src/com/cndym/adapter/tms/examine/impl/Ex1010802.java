 ...
 */
@Component
public class Ex1010802 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010802.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1010802", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
//        for (String num : nums) {
...
//        }
    ...
    public static void main(String[] args) {
        Ex1010802 ex1020802 = new Ex1010802();
