...
@Component
public class Ex1071701 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(num, ",", 5L, 0L);
    ...
    public static void main(String[] s){
    	Ex1071701 e = new Ex1071701();
    	e.examina("01,02,08,04,05", 7);
    }
}
