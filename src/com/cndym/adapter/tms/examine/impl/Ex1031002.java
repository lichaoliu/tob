 ...
 */
@Component
public class Ex1031002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1031002.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1031002", nums);
         for (String n : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1031002 ex1030902 = new Ex1031002();
        ex1030902.examina("01,08#02,10#03,11", 8);
