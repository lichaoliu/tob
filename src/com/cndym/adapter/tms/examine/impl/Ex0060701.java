...
@Component
public class Ex0060701 extends BashExamina implements IExamine {

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int ticket = nums.length;
        int ticketCount = getTicketCount("0060701");
    ...
    public static void main(String[] args) {
        Ex0060701 ex0060701 = new Ex0060701();
        ex0060701.examina("1,2,2", 5);
