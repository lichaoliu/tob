 ...
 */
@Component
public class Ex1030901 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1030901.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1030901", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1030901 ex1030901 = new Ex1030901();
        ex1030901.examina("01#02;03#04;05#06;07#02;03#05", 5);
