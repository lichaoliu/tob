 ...
 */
@Component
public class Ex1121201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1121201.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1121201", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1121201 ex1111201 = new Ex1121201();
        ex1111201.examina("01,02,03;02,03,04;05,06,07;07,08,09;08,09,10", 5);
