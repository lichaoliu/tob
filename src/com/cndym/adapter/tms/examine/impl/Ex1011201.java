 ...
 */
@Component
public class Ex1011201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1011201.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1011201", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1011201 ex1021201 = new Ex1011201();
