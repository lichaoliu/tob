 ...
 */
@Component
public class Ex1040203 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1040203.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1040203", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1040203 ex0063001 = new Ex1040203();
        ex0063001.examina("01@02,03;02@04,09;01@02,06,11", 7);
