...
@Component
public class Ex0130501 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0130501.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0130501", nums);
...
//            NumberSortExamine.defaulstNumberSortExamine(num, ",");//  验证号码是否按升序排序
    ...
    public static void main(String[] ages) {
        Ex0130501 ex0070501 = new Ex0130501();
