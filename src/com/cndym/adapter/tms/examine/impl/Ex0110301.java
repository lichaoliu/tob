...
@Component
public class Ex0110301 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0110301.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0110301", nums);
        NumberSortExamine.defaulstNumberSortExamine(number.replace(",", ""), ";");//  验证号码是否按升序排序
        for (String num : nums) {
    ...
    public static void main(String[] ages) {
        Ex0110301 ex0070301 = new Ex0110301();
