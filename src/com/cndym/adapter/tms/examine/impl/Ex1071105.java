 ...
 */
@Component
public class Ex1071105 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1071105.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1071105", nums);
//        for (String n : nums) {
//            //校验格式
