...
@Component
public class Ex1071702 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("1071702");
        ...
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(num, ",", 5L, 1L);
    ...
    public static void main(String[] s){
    	Ex1071702 e = new Ex1071702();
    	e.examina("01,02,03,04,05,06", 6);
    }
}
