...
@Component
public class Ex0063001 extends BashExamina implements IExamine {

	@Override
	public void examina(String number, int item) {
		String[] nums = number.split(ztag);
		int ticket = nums.length;
		int ticketCount = getTicketCount("0063001");
		...
		for (String num : nums) {
			...
			for (String numS : numStrs) {
				if ("9,0,1,2".indexOf(numS) > -1) {
					continue;
				} else {
					throw new IllegalArgumentException("注码错误");
				}
			}
		}
		// 校验注数
	...
	public static void main(String[] args) {
		Ex0063001 ex0063001 = new Ex0063001();
		ex0063001.examina("9,1;9,0;9,2;9,1", 4);
