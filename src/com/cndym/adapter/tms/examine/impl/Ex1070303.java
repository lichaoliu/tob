 ...
 */
@Component
public class Ex1070303 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1070303.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1070303", nums);
        for (String num : nums) {
            //校验格式
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[1], ",", 0, 1);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1070303 ex0063001 = new Ex1070303();
        ex0063001.examina("01,04@02,03", 2);
