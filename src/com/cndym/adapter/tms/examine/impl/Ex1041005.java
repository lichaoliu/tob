 ...
 */
@Component
public class Ex1041005 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041005.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1041005", nums);
//        for (String n : nums) {
//            //校验格式
