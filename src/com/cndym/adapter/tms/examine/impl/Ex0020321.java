...
@Component
public class Ex0020321 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0020321.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0020321", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex0020321 ex0020206 = new Ex0020321();
        ex0020206.examina("0,1,2", 1);
