 ...
 */
@Component
public class Ex1121102 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1121102.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1121102", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1121102 ex1111102 = new Ex1121102();
        ex1111102.examina("01,02,03", 3);
