 ...
 */
@Component
public class Ex1040403 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1040403.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1040403", nums);
        for (String num : nums) {
            //校验格式
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 4, -1);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1040403 ex0063001 = new Ex1040403();
        ex0063001.examina("01,05@02,03,09", 3);
