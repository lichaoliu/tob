...
@Component
public class Ex0020224 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0020224.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0020224", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex0020224 ex0010101 = new Ex0020224();
        ex0010101.examina("0,1,1", 1);
