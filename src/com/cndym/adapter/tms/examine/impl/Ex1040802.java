 ...
 */
@Component
public class Ex1040802 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1040802.class);
    ...
    public void examina(String number, int item) {
        ...
        String[] nums = number.split(ztag);
          NumberTicketCountExamine.defaulstNumberSortExamine("1040802", nums);
          int temp = 0;
          for (String num : nums) {
              // 校验格式
    ...
    public static void main(String[] ages) {
        Ex1040802 ex1070802 = new Ex1040802();
        ex1070802.examina("01,02,03,04,05,06,07,08,09,10,11", 165);
