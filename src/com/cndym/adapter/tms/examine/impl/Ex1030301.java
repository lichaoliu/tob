 ...
 */
@Component
public class Ex1030301 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1030301.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1030301", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1030301 ex1030301 = new Ex1030301();
        ex1030301.examina("01,02,03;02,03,04;03,05,08;05,06,09;03,06,07", 5);
