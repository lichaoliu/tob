 ...
 */
@Component
public class Ex3010102 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex3010102.class);

    @Override
    public void examina(String number, int item) {
        //校验格式
        NumberTagExamine.commaNumberTagExamine300(number);//号码中分隔符的验证
        NumberLengthExamine.defaultNumberLengthExamine(number, "\\*", 12, 0);//号码个数的验证
