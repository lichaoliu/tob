 ...
 */
@Component
public class Ex1010902 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010902.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1010902", nums);
         for (String n : nums) {
             //校验格式
...
//            temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1010902 ex1020902 = new Ex1010902();
        ex1020902.examina("01,08#05,07", 4);
