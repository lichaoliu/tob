 ...
 */
@Component
public class Ex1030402 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1030402.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1030402", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1030402 ex1030402 = new Ex1030402();
        ex1030402.examina("01,02,03,04,05", 5);
