 ...
 */
@Component
public class Ex1010302 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010302.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1010302", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1010302 ex1020302 = new Ex1010302();
        ex1020302.examina("01,02,03,05", 4);
