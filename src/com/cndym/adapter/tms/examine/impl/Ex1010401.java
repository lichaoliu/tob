 ...
 */
@Component
public class Ex1010401 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010401.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1010401", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1010401 ex1020401 = new Ex1010401();
        ex1020401.examina("01,02,03,04;02,03,04,05;03,05,08,09;02,05,06,09;03,06,07,09", 5);
