 ...
 */
@Component
public class Ex1061103 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1061103.class);
...
//        int temp = 0;
//        NumberTicketCountExamine.defaulstNumberSortExamine("1071103", nums);
//        for (String n : nums) {
////        校验格式
