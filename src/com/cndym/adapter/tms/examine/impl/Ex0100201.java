...
@Component
public class Ex0100201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0100201.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0100201", nums);
    ...
    public static void main(String[] ages) {
        Ex0100201 ex0070201 = new Ex0100201();
        ex0070201.examina("1,2,2;5,5,6;2,2,6", 3);
    }
}
