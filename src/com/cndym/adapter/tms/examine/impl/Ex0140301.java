...
@Component
public class Ex0140301 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0140301.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0140301", nums);
    ...
    public static void main(String[] ages) {
        Ex0140301 ex0070301 = new Ex0140301();
