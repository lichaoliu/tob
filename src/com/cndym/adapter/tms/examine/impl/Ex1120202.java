 ...
 */
@Component
public class Ex1120202 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1120202.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1120202", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1120202 ex1110202 = new Ex1120202();
        ex1110202.examina("01,02,03,04,05", 55);
