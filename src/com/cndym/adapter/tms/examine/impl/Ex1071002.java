 ...
 */
@Component
public class Ex1071002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1071002.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1071002", nums);
        for (String n : nums) {
            //校验格式
...
//           temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1071002 ex0063001 = new Ex1071002();
        ex0063001.examina("01#11,09;01,06#03", 4);
