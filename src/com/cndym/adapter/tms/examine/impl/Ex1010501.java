 ...
 */
@Component
public class Ex1010501 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010501.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1010501", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1010501 ex1020501 = new Ex1010501();
        ex1020501.examina("01,02,03,04,05;02,03,04,05,06;03,05,08,09,10;02,03,05,06,09;03,06,07,09,10", 5);
