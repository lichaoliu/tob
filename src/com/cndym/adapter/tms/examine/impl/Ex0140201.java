...
@Component
public class Ex0140201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0140201.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0140201", nums);
...
//            NumberSortExamine.defaulstNumberSortExamine(num, ",");//  验证号码是否按升序排序
    ...
    public static void main(String[] ages) {
        Ex0140201 ex0070201 = new Ex0140201();
