...
@Component
public class Ex0080207 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("0080207");
    ...
    public static void main(String[] args) {
        Ex0080207 ex0060207 = new Ex0080207();
        ex0060207.examina("1,2;2,2", 4);
