...
@Component
public class Ex1071503 extends BashExamina implements IExamine {
    ...
    public void examina(String number, int item) {
        ...
        int ticket = getTicketCount("1071503");
        ...
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 3L, -1L);
            NumberLengthExamine.defaultNumberLengthExamine(arr[1], ",", 0L, 1L);
