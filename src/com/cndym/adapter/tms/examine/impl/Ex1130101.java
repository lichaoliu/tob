 ...
 */
@Component
public class Ex1130101 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1130101.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1130101", nums);
        for (String num : nums) {
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 5, 0);//号码个数的验证
            NumberLengthExamine.defaultNumberLengthExamine(arr[1], ",", 2, 0);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1130101 ex1080402 = new Ex1130101();
        ex1080402.examina("01,02,03,04,05#01,02;01,02,03,04,05#01,09;01,02,03,04,05#01,09;01,02,03,04,05#01,09;01,02,03,04,05#01,09;01,02,03,04,05#01,09", 2);
