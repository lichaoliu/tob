 ...
 */
@Component
public class Ex1111002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1111002.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1111002", nums);
         for (String n : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1111002 ex1110902 = new Ex1111002();
        ex1110902.examina("01,08#02,10#03,11", 8);
