...
@Component
public class Ex0020324 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0020324.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0020324", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex0020324 ex0020101 = new Ex0020324();
