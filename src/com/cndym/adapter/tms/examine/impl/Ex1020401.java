 ...
 */
@Component
public class Ex1020401 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1020401.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1020401", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1020401 ex1020401 = new Ex1020401();
