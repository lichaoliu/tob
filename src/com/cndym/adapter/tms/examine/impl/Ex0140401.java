...
@Component
public class Ex0140401 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0140401.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0140401", nums);
    ...
    public static void main(String[] ages) {
        Ex0140401 ex0070201 = new Ex0140401();
