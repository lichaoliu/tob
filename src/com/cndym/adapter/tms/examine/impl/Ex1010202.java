 ...
 */
@Component
public class Ex1010202 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010202.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1010202", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1010202 ex1020202 = new Ex1010202();
        ex1020202.examina("01,02,03,04,05,06,07,08,09,10,11", 55);
