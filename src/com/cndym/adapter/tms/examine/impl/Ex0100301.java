...
@Component
public class Ex0100301 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0100301.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0100301", nums);
    ...
    public static void main(String[] ages) {
        Ex0100301 ex0070301 = new Ex0100301();
