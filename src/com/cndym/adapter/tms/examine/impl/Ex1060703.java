 ...
 */
@Component
public class Ex1060703 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1060703.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1060703", nums);
        for (String num : nums) {
            //校验格式
            ...
            NumberLengthExamine.defaultNumberLengthExamine(arr[0], ",", 7, -1);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1060703 ex0063001 = new Ex1060703();
        ex0063001.examina("01,02@03,04,06,07,08,09,10;01@02,03,04,06,09,10,11", 28);
