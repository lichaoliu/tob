 ...
 */
@Component
public class Ex1060403 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1060403.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1060403", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1060403 ex0063001 = new Ex1060403();
