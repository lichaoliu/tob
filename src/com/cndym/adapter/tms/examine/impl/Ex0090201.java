...
@Component
public class Ex0090201 extends BashExamina implements IExamine {

	@Override
	public void examina(String number, int item) {
		String[] nums = number.split(ztag);
		NumberTicketCountExamine.defaulstNumberSortExamine("0090201", nums);
	...
	public static void main(String[] args) {
		Ex0090201 ex = new Ex0090201();
		ex.examina("1,2;2,3", 2);
