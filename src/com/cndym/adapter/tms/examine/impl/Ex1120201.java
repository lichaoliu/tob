 ...
 */
@Component
public class Ex1120201 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1120201.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1120201", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1120201 ex1110201 = new Ex1120201();
        ex1110201.examina("01,02;03,04", 2);
