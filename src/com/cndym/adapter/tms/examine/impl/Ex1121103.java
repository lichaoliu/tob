 ...
 */
@Component
public class Ex1121103 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1121103.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1121103", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1121103 ex1111103 = new Ex1121103();
        ex1111103.examina("01@02,03,04,05,06,07,08,09,10,11", 10);
