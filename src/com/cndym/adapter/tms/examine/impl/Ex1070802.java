 ...
 */
@Component
public class Ex1070802 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1070802.class);
    ...
    public void examina(String number, int item) {
        ...
        String[] nums = number.split(ztag);
          NumberTicketCountExamine.defaulstNumberSortExamine("1070802", nums);
          int temp = 0;
          for (String num : nums) {
              // 校验格式
    ...
    public static void main(String[] ages) {
        Ex1070802 ex1070802 = new Ex1070802();
