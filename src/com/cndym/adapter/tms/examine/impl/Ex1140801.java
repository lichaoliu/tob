 ...
 */
@Component
public class Ex1140801 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1140801.class);

    @Override
    public void examina(String number, int item) {

		 String[] nums = number.split(ztag);
		 NumberTicketCountExamine.defaulstNumberSortExamine("1140801", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1140801 ex1140801 = new Ex1140801();
        ex1140801.examina("22", 1);
