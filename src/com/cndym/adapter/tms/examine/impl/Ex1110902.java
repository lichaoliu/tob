 ...
 */
@Component
public class Ex1110902 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1110902.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1110902", nums);
         for (String n : nums) {
             //校验格式
...
//            temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1110902 ex1110902 = new Ex1110902();
