 ...
 */
@Component
public class Ex1020902 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1020902.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1020902", nums);
         for (String n : nums) {
             //校验格式
...
//            temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1020902 ex1020902 = new Ex1020902();
