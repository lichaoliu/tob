 ...
 */
@Component
public class Ex1060303 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1060303.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1060303", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1060303 ex0063001 = new Ex1060303();
