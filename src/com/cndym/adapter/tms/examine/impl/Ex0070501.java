...
@Component
public class Ex0070501 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0070501.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0070501", nums);
        for (String num : nums) {
    ...
    public static void main(String[] ages) {
        Ex0070501 ex0070501 = new Ex0070501();
        ex0070501.examina("3,2,1;2,3,4", 2);
    }
}
