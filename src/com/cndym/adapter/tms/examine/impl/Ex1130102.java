 ...
 */
@Component
public class Ex1130102 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1130102.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1130102", nums);
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1130102 ex1080402 = new Ex1130102();
        ex1080402.examina("01,02,03,04,05#01,02,03;01,02,03,04,05#01,09,12", 6);
