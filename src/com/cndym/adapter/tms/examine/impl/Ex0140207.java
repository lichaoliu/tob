...
@Component
public class Ex0140207 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0140207.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0140207", nums);
    ...
    public static void main(String[] ages) {
        Ex0140207 ex0070207 = new Ex0140207();
