 ...
 */
@Component
public class Ex1010603 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010603.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1010603", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	//校验格式
    ...
    public static void main(String[] args) {
        Ex1010603 ex1020603 = new Ex1010603();
        ex1020603.examina("01,02,03,07,09@06,05,08", 3);
