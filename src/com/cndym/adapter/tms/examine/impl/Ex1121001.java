 ...
 */
@Component
public class Ex1121001 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1121001.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1121001", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1121001 ex1111001 = new Ex1121001();
        ex1111001.examina("01#02#03;03#04#05;05#06#08;07#02#01;03#05#09", 5);
