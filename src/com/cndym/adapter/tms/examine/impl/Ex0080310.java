...
@Component
public class Ex0080310 extends BashExamina implements IExamine {

    @Override
    public void examina(String number, int item) {
        String tag = ",";
        String[] nums = number.split(ztag);
        int ticket = getTicketCount("0080310");
    ...
    public static void main(String[] args) {
        Ex0080310 ex0060307 = new Ex0080310();
        ex0060307.examina("1,2,9", 3);
