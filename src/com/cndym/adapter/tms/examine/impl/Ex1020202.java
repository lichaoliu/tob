 ...
 */
@Component
public class Ex1020202 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1020202.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1020202", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
    ...
    public static void main(String[] args) {
        Ex1020202 ex1020202 = new Ex1020202();
