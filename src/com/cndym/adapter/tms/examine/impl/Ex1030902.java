 ...
 */
@Component
public class Ex1030902 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1030902.class);
    ...
    public void examina(String number, int item) {
         ...
         int temp = 0;
         NumberTicketCountExamine.defaulstNumberSortExamine("1030902", nums);
         for (String n : nums) {
             //校验格式
...
//            temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1030902 ex1030902 = new Ex1030902();
        ex1030902.examina("01,08#1011", 4);
