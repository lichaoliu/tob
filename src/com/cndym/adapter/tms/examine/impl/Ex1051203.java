 ...
 */
@Component
public class Ex1051203 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1051203.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1051203", nums);
        for (String num : nums) {
            //校验格式
