 ...
 */
@Component
public class Ex1041102 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041102.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1041102", nums);
        for (String n : nums) {
            //校验格式
...
//        int temp = itemCount(n);
    ...
    public static void main(String[] args) {
        Ex1041102 ex0063001 = new Ex1041102();
