 ...
 */
@Component
public class Ex1070403 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1070403.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1070403", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1070403 ex0063001 = new Ex1070403();
