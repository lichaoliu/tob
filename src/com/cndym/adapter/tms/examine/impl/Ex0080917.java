...
@Component
public class Ex0080917 extends BashExamina implements IExamine {

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int ticket = nums.length;
        int ticketCount = getTicketCount("0080917");
    ...
    public static void main(String[] args) {
        Ex0080917 ex0060801 = new Ex0080917();
        ex0060801.examina("15;15;5", 3);
