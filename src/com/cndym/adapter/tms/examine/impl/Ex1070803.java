 ...
 */
@Component
public class Ex1070803 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1070803.class);

    @Override
    public void examina(String number, int item) {
//        throw new IllegalArgumentException("该玩法暂不支持");
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1070803", nums);
        int temp = 0;
        for (String num : nums) {
            //校验格式
