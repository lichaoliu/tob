...
@Component
public class Ex0080601 extends BashExamina implements IExamine {

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int ticket = nums.length;
        int ticketCount = getTicketCount("0080601");
    ...
    public static void main(String[] args) {
        Ex0080601 ex0060101 = new Ex0080601();
        ex0060101.examina("1,9;1,9;1,8;1,0", 4);
