 ...
 */
@Component
public class Ex1040302 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1040302.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1040302", nums);
        for (String num : nums) {
            //校验格式
...
//            NumberLengthExamine.defaultNumberLengthExamine(num, ",", 5, -1);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1040302 ex0063001 = new Ex1040302();
