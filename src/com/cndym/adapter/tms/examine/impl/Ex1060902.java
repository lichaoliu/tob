 ...
 */
@Component
public class Ex1060902 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1060902.class);
...
//        throw new IllegalArgumentException("该玩法暂不支持");
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1060902", nums);
        for (String num : nums) {
            //校验格式
