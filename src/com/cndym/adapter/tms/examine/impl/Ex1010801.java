 ...
 */
@Component
public class Ex1010801 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1010801.class);

    @Override
    public void examina(String number, int item) {

        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1010801", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
    ...
    public static void main(String[] args) {
        Ex1010801 ex1030801 = new Ex1010801();
        ex1030801.examina("01,02,03,04,05,06,07,08;02,03,04,05,06,07,09,10;01,02,03,05,08,09,10,11;01,02,03,04,05,06,09,10;02,03,04,06,07,09,10,11", 5);
