 ...
 */
@Component
public class Ex1030503 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1030503.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1030503", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	//校验格式
    ...
    public static void main(String[] args) {
        Ex1030503 ex1030503 = new Ex1030503();
        ex1030503.examina("01,02,03,07@04,05,08", 3);
