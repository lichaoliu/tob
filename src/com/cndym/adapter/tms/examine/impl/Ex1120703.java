 ...
 */
@Component
public class Ex1120703 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1120703.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1120703", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	//校验格式
    ...
    public static void main(String[] args) {
        Ex1120703 ex1110703 = new Ex1120703();
