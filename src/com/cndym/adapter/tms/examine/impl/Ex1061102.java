 ...
 */
@Component
public class Ex1061102 extends BashExamina implements IExamine {
	private Logger logger = Logger.getLogger(Ex1061102.class);

	@Override
	public void examina(String number, int item) {
		String[] nums = number.split(ztag);
		int temp = 0;
		NumberTicketCountExamine.defaulstNumberSortExamine("1061102", nums);
		for (String n : nums) {
			// 校验格式
	...
	public static void main(String[] args) {
		Ex1061102 ex = new Ex1061102();
		ex.examina("01,09#02#11", 2);
