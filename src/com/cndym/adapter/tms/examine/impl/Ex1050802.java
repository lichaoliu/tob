 ...
 */
@Component
public class Ex1050802 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1050802.class);
...
//          NumberTicketCountExamine.defaulstNumberSortExamine("1050802", nums);
//          int temp = 0;
//          for (String num : nums) {
//              // 校验格式
