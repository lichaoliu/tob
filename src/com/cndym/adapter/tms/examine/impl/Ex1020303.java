 ...
 */
@Component
public class Ex1020303 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1020303.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1020303", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	//校验格式
    ...
    public static void main(String[] args) {
        Ex1020303 ex1020303 = new Ex1020303();
        ex1020303.examina("01,02@03,06", 2);
