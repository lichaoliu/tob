 ...
 */
@Component
public class Ex3030102 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex3030102.class);
    ...
    public void examina(String number, int item) {
        ...
        if(count != 5){
        	...
        	throw new IllegalArgumentException("号码(" + number + ")不是九场!");
        }
    ...
    public static void main(String args[]){
    	Ex3030102 ex = new Ex3030102();
    	ex.examina("4*30*4*3*1*4*3*4*1*3*1*1*3*4",2);
