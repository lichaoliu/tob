 ...
 */
@Component
public class Ex1011103 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1011103.class);
    ...
    public void examina(String number, int item) {
        ...
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1011103", nums);//验证号码的票数，必须与配置文件lotteryInfo.xml相符
        for (String num : nums) {
        	 //校验格式
    ...
    public static void main(String[] args) {
        Ex1011103 ex1021103 = new Ex1011103();
