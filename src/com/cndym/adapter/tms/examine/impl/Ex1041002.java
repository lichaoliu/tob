 ...
 */
@Component
public class Ex1041002 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041002.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1041002", nums);
        for (String n : nums) {
            //校验格式
...
//           temp = itemCount(ges, shis);
    ...
    public static void main(String[] args) {
        Ex1041002 ex0063001 = new Ex1041002();
