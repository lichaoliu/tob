 ...
 */
@Component
public class Ex1041202 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1041202.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        int temp = 0;
        NumberTicketCountExamine.defaulstNumberSortExamine("1041202", nums);
        for (String num : nums) {
            //校验格式
...
//            NumberLengthExamine.defaultNumberLengthExamine(num, ",", 9, -1);//号码个数的验证
    ...
    public static void main(String[] args) {
        Ex1041202 ex0063001 = new Ex1041202();
