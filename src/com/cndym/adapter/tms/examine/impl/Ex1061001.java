 ...
 */
@Component
public class Ex1061001 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex1061001.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("1061001", nums);
        for (String num : nums) {
            //校验格式
    ...
    public static void main(String[] args) {
        Ex1061001 ex0063001 = new Ex1061001();
