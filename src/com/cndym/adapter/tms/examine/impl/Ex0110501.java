...
@Component
public class Ex0110501 extends BashExamina implements IExamine {
    private Logger logger = Logger.getLogger(Ex0110501.class);

    @Override
    public void examina(String number, int item) {
        String[] nums = number.split(ztag);
        NumberTicketCountExamine.defaulstNumberSortExamine("0110501", nums);
        for (String num : nums) {
    ...
    public static void main(String[] ages) {
        Ex0110501 ex0070501 = new Ex0110501();
