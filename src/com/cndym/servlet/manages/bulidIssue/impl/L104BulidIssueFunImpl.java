...
@Component
public class L104BulidIssueFunImpl implements IBulidIssueFun {
    @Autowired
    ...
    public int bulid(String lotteryCode, String startDate, int days) {
        try {
            Date inputDate = Utils.formatDate(startDate + " 08:10:00", "yyyy-MM-dd HH:mm:ss");
            ...
            for (int j = 0; j < days; j++) {
                ...
                String issueFirst = Utils.formatDate2Str(calendar.getTime(), "yyyyMMdd");
                for (int i = 1; i <= 85; i++) {
