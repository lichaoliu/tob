...
@Component
public class L011BulidIssueFunImpl implements IBulidIssueFun {
	@Autowired
	...
	public int bulid(String lotteryCode, String startDate, int days) {
		try {
			Date inputDate = Utils.formatDate(startDate + " 08:30:00", "yyyy-MM-dd HH:mm:ss");
	...
	public static void main(String args[]) {
		L011BulidIssueFunImpl issue = new L011BulidIssueFunImpl();
		issue.bulid("011", "2013-10-25", 1);
	}
}
