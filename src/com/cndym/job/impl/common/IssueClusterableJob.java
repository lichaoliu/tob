 ...
 */
@Service("issueQuartzJob")
public class IssueClusterableJob implements ITaskSchedule{
	...
	public void execute(){
		...
		IPostIssueService postIssueService = (IPostIssueService) SpringUtils.getBean("postIssueServiceImpl");
