 ...
 * email：cndym@163.com
 * <p/>
 * send.to.client.issue
 */
@Component
public class SendToClientIssueMessagesListener implements MessageListener {
        ...
        try {
            if (message instanceof MapMessage) {
                ...
                if (oMsg instanceof ActiveMQMapMessage) {
                    ...
                    logger.error("Message:[" + message + "] is not a instance of ActiveMQObjectMessage[SendToClientIssueMessages].");
                    throw new JMSException("Message:[" + message + "] is not a instance of ActiveMQObjectMessage[SendToClientIssueMessages].");
                }
            } else {
