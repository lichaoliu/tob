 ...
 * QQ：757579248
 * email：cndym@163.com
 * send.to.client.bonus
 */
@Component
public class SendToClientBonusInfoMessagesListener implements MessageListener {
        ...
        try {
            if (message instanceof MapMessage) {
                ...
                if (oMsg instanceof ActiveMQMapMessage) {
                    ...
                    logger.error("Message:[" + message + "] is not a instance of ActiveMQObjectMessage[SendToClientBonusMessages].");
                    throw new JMSException("Message:[" + message + "] is not a instance of ActiveMQObjectMessage[SendToClientBonusMessages].");
                }
            } else {
